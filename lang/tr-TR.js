export default async () => {
  return await Promise.resolve({
    ...
    hero: {
      text1: "Termal iç giyim koleksiyonumuz ile soğuktan uzak durun.",
      text2:
    ...
    faq: {
      ...
      fabrics: "Termal iç çamaşırı yapımında kullanılan çamaşırlar nelerdir?",
      fabAnswer: [
      ...
      features: "İdeal bir termal iç çamaşırının özellikleri nelerdir?",
      featAnswer: [
